sap.ui.define([
    ...
    return BaseController.extend("com.ncs.btp.buildinbox.controller.CustomerBP", {
        ...
        _setViewSettings:function(){
            ...
            this.getModel("objectView").setProperty("/isFinalApprover",oTaskDetails.activityId === "form_financeDepartmentApproval_1");
        },
            ...
            this.updateService('A').then(function (data) {
                ...
                let oFuncSuccess = function (oResp) {
                    ...
                    if(isFinalAppprover){
                    	...
                    	sMessage = "Customer Business Partner created successfully: "+data.BusinessPartner;
        ...
        updateService:function(status){
            let oBAPIModel = this.getModel("customerBAPIService");
            ...
            return new Promise(function (resolve, reject) {
                oBAPIModel.create("/FinanceDataCustomerSet",oPayload,{success:function(){
        ...
        getVendorDetails: function (sId) {
            ...
            debugger;
            this.getView().bindElement({
                path: "customerService>"+"/CustomerData(Rootid="+sId+",IsActiveEntity=true)",
                events: {
                    //change: this._onBindingChange.bind(this),
                    dataRequested: function () {
                        // debugger;
