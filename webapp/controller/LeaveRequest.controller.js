sap.ui.define([
    ...
    return BaseController.extend("com.ncs.btp.buildinbox.controller.LeaveRequest", {
        ...
        _setModels: function () {
            ...
            var oRequestDetails = {
                ...
                "BasicData": {
                    ...
                    "empname": "Sourav",
                    "leaveType": "Medical",
                    "fromdate": "Wed Nov 08 2023",
                    "todate": "Thu Nov 09 2023",
                    "leavedays": "2 Days",
                    "reason": "fever",
                    "period": "",
                    "return": "Fri Nov 10 2023"
                },
                "Receipent": {
                    "cc": "100",
                    "purchGroup": "GRP 001",
            ...
            this.getView().setModel(new sap.ui.model.json.JSONModel(oRequestDetails), "LR");
        },
