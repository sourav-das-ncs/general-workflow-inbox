		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Inbox",
									"targetURL": "#comncsbtpbuildinbox-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comncsbtpbuildinbox-display": {
								"semanticObject": "comncsbtpbuildinbox",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ncs.btp.buildinbox",
									"url": sap.ui.require.toUrl("com/ncs/btp/buildinbox")
								}
							}
						}
					}
